    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white" ref={ref}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <div className="inline-block bg-ranch-primary/10 text-ranch-primary px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-semibold mb-3 sm:mb-4">
              100% オーガニック
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-ranch-primary mb-4 sm:mb-6">
              自然のめぐみを
              <br />
              そのままに
            </h2>
            ...
            <ul className="space-y-3 sm:space-y-4">
              {commitments.map((item, index) => (
                ...
                >
                  <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-ranch-primary flex-shrink-0 mt-0.5" />
            ...
            >
              <a
                href="/about"
                className="inline-block bg-ranch-primary hover:bg-ranch-light text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold transition-all duration-300 hover:scale-105 shadow-lg text-sm sm:text-base"
              >
                牧場について詳しく
              </a>
            </motion.div>
